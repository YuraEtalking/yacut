...
Revision ID: 7e2df949424b
Revises: 
Create Date: 2025-09-07 11:59:08.205622
...
def upgrade():
    ...
    sa.Column('original', sa.String(length=1999), nullable=False),
    sa.Column('short', sa.String(length=7), nullable=False),
